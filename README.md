...
## **Running via docker**
    ...
    $ docker run --rm -it -v ${pwd}/credentials:/app/data/credentials -v ${pwd}/instances:/app/data/instances -v ${pwd}/logs:/app/data/logs -e RPP_DISCORD_CLIENT_ID=111....1111 -e RPP_DISCORD_TOKEN=token --name rpp ghcr.io/alexemanuelol/rustplusplus
